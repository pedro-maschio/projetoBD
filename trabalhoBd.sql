...
# Filme
INSERT INTO filme VALUES(1, "A Outra História Americana", 1998, "	", LOAD_FILE("/var/lib/mysql-files/american-history-x.jpg"), 119, "Edward Norton, Fairuza Balk, Avery Brooks etc.", "Crime/Drama", "Derek (Edward Norton) busca vazão para suas agruras tornando-se líder de uma gangue de racistas. A violência o leva a um assassinato, e ele é condenado pelo crime. Três anos mais tarde, ele sai da prisão e tem que convencer seu irmão (Edward Furlong), que está prestes a assumir a liderança do grupo, a não trilhar o mesmo caminho.");
...
# Procedure que busca exibições em um intervalo de datas
